...
<\body>
  ...
  editor>>>|<point|0.0|9.25>>>|<with|color|white|<text-at|<tabular|<tformat|<twith|table-width|9cm>|<twith|table-hmode|exact>|<cwith|1|1|1|1|cell-hyphen|t>|<twith|table-valign|T>|<table|<row|<\cell>
    <\itemize>
      ...
      insert mathematical formulas, hyperlinks, and other types of objects
      into such pictures.
    </itemize>
  </cell>>>>>|<point|-4.5|8.25>>>|<with|color|white|<text-at|<tabular|<tformat|<cwith|1|1|1|1|cell-hyphen|t>|<twith|table-width|9cm>|<twith|table-hmode|exact>|<twith|table-valign|T>|<table|<row|<\cell>
    <\itemize>
      ...
      <item>Its rendering engine uses high-quality typesetting algorithms so
      as to produce professionally looking documents, which can either be
      printed out or presented from a laptop.
      ...
      <item>New styles can be written by the user and new features can be
      added to the editor using the <name|Scheme> extension language.
    ...
    <\session|maxima|default>
      ...
      <|unfolded-io-math>
        <with|math-display|true|<big|int><frac|x<rsup|3>|x<rsup|2>+x+1>*\<mathd\>
        x>
      <|unfolded-io-math>
        <math|<with|math-display|true|<text|<with|font-family|tt|color|red|(<with|math-font-family|rm|%o2>)
        >><frac|2*arctan <around*|(|<frac|2*x+1|<sqrt|3>>|)>|<sqrt|3>>+<frac|x<rsup|2>-2*x|2>>>
      </unfolded-io-math>
  ...
  <\wide-block>
    <tformat|<cwith|1|1|1|1|cell-background|#0000c0>|<table|<row|<\cell>
      \;

      <with|gr-mode|<tuple|group-edit|edit-props>|gr-frame|<tuple|scale|1.18926cm|<tuple|0.501011gw|0.0224006gh>>|gr-geometry|<tuple|geometry|0.266686par|0.209992par|bottom>|gr-grid|<tuple|cartesian|<point|0|0>|1>|gr-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-edit-grid-aspect|<tuple|<tuple|axes|none>|<tuple|1|none>|<tuple|4|none>>|gr-edit-grid|<tuple|cartesian|<point|0|0>|1>|gr-edit-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-grid-aspect-props|<tuple|<tuple|axes|#aaf>|<tuple|1|#aaf>|<tuple|4|blue>>|gr-grid-aspect|<tuple|<tuple|axes|#aaf>|<tuple|1|#aaf>|<tuple|4|blue>>|gr-color|white|magnify|1.18920711283083|gr-point-style|round|gr-point-size|4ln|gr-text-at-valign|center|gr-transformation|<tuple|<tuple|0.995004165278026|0.0|-0.0998334166468281|0.0>|<tuple|0.0|1.0|0.0|0.0>|<tuple|0.0998334166468281|0.0|0.995004165278026|0.0>|<tuple|0.0|0.0|0.0|1.0>>|<graphics||<with|color|#ffa|<carc|<point|0|5>|<point|2.0|3.0>|<point|0.0|1.0>>>|<with|color|#ffa|<spline|<point|-3.0|9.0>|<point|0.0|0.0>|<point|3.0|9.0>>>|<with|color|orange|line-width|2ln|<cline|<point|-1.90211|3.61803>|<point|-1.17557050458347|1.38196601124903>|<point|1.17557050458537|1.38196601125041>|<point|1.90211303259009|3.61803398875058>|<point|0.0|5.0>>>|<with|color|#fa6|point-size|4ln|fill-color|white|point-style|round|<point|0|5>>|<with|color|#fa6|point-size|4ln|fill-color|white|point-style|round|<point|1.90211|3.61803>>|<with|color|#fa6|point-size|4ln|fill-color|white|point-style|round|<point|1.17557|1.38197>>|<with|color|#fa6|point-size|4ln|fill-color|white|point-style|round|<point|-1.17557|1.38197>>|<with|color|#fa6|point-size|4ln|fill-color|white|point-style|round|<point|-1.90211|3.61803>>|<with|color|#fa6|point-size|4ln|fill-color|white|point-style|round|<point|0|3>>|<with|color|white|text-at-valign|center|text-at-halign|left|<math-at|2|<point|0.25|4>>>|<with|color|white|text-at-valign|center|text-at-halign|left|<math-at|\<phi\>|<point|0.25|2.25>>>|<with|color|white|<spline|<point|0|5>|<point|0.125|4.0>|<point|0.0|3.0>>>|<with|color|white|<spline|<point|0|3>|<point|0.125|2.25>|<point|0.0|1.38196601124972>>>>>
...
<\initial>
  <\collection>
    ...
    <associate|page-bot|0mm>
    <associate|page-even|0mm>
    <associate|page-even-footer|>
    <associate|page-even-header|>
    <associate|page-height|20cm>
    <associate|page-medium|paper>
    <associate|page-odd|0mm>
    <associate|page-odd-footer|>
    <associate|page-odd-header|>
    <associate|page-right|0mm>
    <associate|page-screen-margin|false>
    <associate|page-top|0mm>
    <associate|page-type|user>
    <associate|page-width|30cm>
