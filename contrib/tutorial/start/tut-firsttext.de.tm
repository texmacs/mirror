...
<\body>
  <tmdoc-title|Writing a simple text>
  ...
  <big-figure|<screenshot|simple-1.en.png>|Typing a simple text using
  TeXmacs.>
  ...
  <big-figure|<screenshot|simple-3.en.png>|TeXmacs automatically
  ...
  <with|font-family|tt|a4> in Europe or <with|font-family|tt|letter> in the
  <abbr|U.S.A.>) and the printer's precision in dots per inch
  (<with|font-family|tt|600> is default).
  ...
  <big-figure|<screenshot|load.en.png>|Retrieving the simple text from the
  disk.>
