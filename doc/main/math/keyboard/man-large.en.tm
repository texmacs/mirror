...
<\body>
  ...
  delimiters. But there status can be changed using the <kbd-large|l>,
  <kbd-large|r> and <kbd-large|m> key combinations. For instance,
  <kbd-large|l )> produces <with|mode|math|)>, considered as a large left
  delimiter.
