...
<\body>
  ...
  <\equation*>
    <left|(|1> <left|(|2> <left|(|3> <left|(|4><space|2em><left|(|5mm>
  </equation*>

  When specifying an additional third argument, the second and third
  arguments correspond to the heights of the lower and upper limit of the
  bracket. This allows you to type the following kind of<nbsp>brackets:
