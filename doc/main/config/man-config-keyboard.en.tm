...
<\body>
  <tmdoc-title|Keyboard modifiers>

  Also, <TeXmacs> comes with a powerful keyboard shortcut system, which
  attempts to optimize the use of the modifier keys like <prefix|S-> and
  <prefix|C-> on your keyboard. However, on certain systems these modifier
  keys are not well configured, so that you may wish to redo this yourself.
  ...
  <\description>
    ...
    <strong|strong> text in text mode and a square root <math|<sqrt|>> in
    math mode. Notice that <prefix|A-> is equivalent to <key*|escape escape>.
